...
class CsvDS(DataSource):
    ...
    def __init__(self, _dataQueue: Queue = None, _isThread=False) -> None:
        super().__init__(_dataQueue, _isThread)
        DataSource.results = None

    def extract(self, _sorucePath: str) -> Queue | None:
        self.TargetMethod = "extract"
        self.Data.put(pandas.read_csv(_sorucePath))
        return self.Data
...
class HtmlDS(DataSource):
    ...
    def extract(self, _sorucePath: str) -> Queue | None:
        self.Data.put(pandas.read_html(_sorucePath))
        return self.Data
...
class JsonDF(DataSource):
    ...
    def extract(self, _sorucePath: str) -> Queue | None:
        self.Data.put(pandas.read_json(_sorucePath))
        return self.Data
...
class XmlDS(DataSource):
    ...
    def extract(self, _sorucePath: str) -> Queue | None:
        self.Data.put(pandas.read_xml(_sorucePath))
        return self.Data
...
class ExcelDS(DataSource):
    ...
    def extract(self, _sorucePath: str) -> Queue | None:
        self.Data.put(pandas.read_excel(_sorucePath))
        return self.Data
